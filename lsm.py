...
user1 = Label(root, text="Length of clear span")
user2 = Label(root, text="Value of UDL")
user3 = Label(root, text="Value of concrete strength")
user4 = Label(root, text="Value of steel strength")
...
Button(text="Submit", command=lsmFun).grid(row=12, column=1)
